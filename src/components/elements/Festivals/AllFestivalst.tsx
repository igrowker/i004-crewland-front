...
export default function AllFestivalst() {
    ...
    <article className='mt-10'>
      <section className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6 mb-24'>
        {dataFestivals.length === 0 ? (
          <p>Cargando festivales...</p> // Mensaje de carga
        ) : (
          dataFestivals.map(festival => (
            ...
            >
              ...
              <div className="p-4 flex flex-col justify-between relative rounded-bl-xl rounded-br-xl"
                style={{
